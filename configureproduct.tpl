<link href="../themes/cart/efcart/assets/css/configureproduct.css" rel="stylesheet">
{if isset($Get.i)}
...
data-style="btn-default" style="border-radius: 0px;">
...
{/if}" style="background-color: #fff;color: #0064ff;border-radius: 0px;">
...
style="width: 100%;" onclick="rangeChange(this)" style="border-radius: 0px;">
...
<div class="col-md-10">
<div class="btn-group-toggle btn-custom-group mt-2 mt-xl-0" data-toggle="buttons">
{foreach $option.sub as $sub_key=>$sub_val}
<label class="btn btn-primary btn-custom hoverer" style="background-color: #fff;color: #0064ff;border-radius: 0px;">
...
class="form-control selectpicker configoption_os selectpicker_refresh" data-style="btn-default" style="border-radius: 0px;">
...
<div class="col-md-3">
<select id="config{$option.id}" name="configoption[{$option.id}]"
class="form-control configoption_os selectpicker" {if
...
data-os-selected="{$getUrlConfig.config_options[$option.id]}" {/if} data-style="btn-default" style="border-radius: 0px;">
...
<select id="config{$option.id}" name="configoption[{$option.id}]"
class="form-control col-md-3 selectpicker" data-style="btn-default" style="border-radius: 0px;">
{foreach $option.sub as $sub_key=>$sub_val}
...
class="btn-group-toggle btn-custom-group mt-2 mt-xl-0" data-toggle="buttons">
{foreach $option.sub as $sub_key=>$sub_val}
<label class="btn btn-primary" style="background-color: #fff;color: #0064ff;border-radius: 0px;height: 40px">
...
class="form-control selectpicker" data-style="btn-default" style="border-radius: 0px;" {if $custom_fields.required}required{/if}>
...
class="form-control getTextareaVal" style="border-radius: 0px;"
...
<label for="example-search-input" class="col-md-2 col-form-label">{$custom_fields.fieldname}</label>
<div class="col-md-3">
<input class="form-control getVal" data-object="{$custom_fields.required}||{$custom_fields.regexpr}" id="customfield[{$custom_fields.id}]" name="customfield[{$custom_fields.id}]" style="border-radius: 0px;"
...
<label class="btn btn-primary btn-custom" style="background-color: #fff;color: #0064ff;border-radius: 0px;">
...
$CartConfig.host}value="{$CartConfig.host}" {else /}value="{$CartConfig.product.host.host}" style="border-radius: 0px;"
{/if} />
...
<!--
<section class="subtop phonehide" style="background-image: url(../themes/cart/efcart/assets/img/home_banner_bg3.png)">
<div class="container">
<div class="row">
<div class="col-sm-12">
<div class="subtop-info">
<h2 class="subtop-title text-center">
配置您的产品
</h2>
<p class="text-center">请选择您需要的配置信息</p>
</div>
</div>
</div>
</div>
