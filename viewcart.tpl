...
<link type="text/css" href="/themes/cart/efcart/assets/js/toastr/build/toastr.min.css?v={$Ver}"
rel="stylesheet" />
<script src="/themes/cart/efcart/assets/js/toastr/build/toastr.min.js?v={$Ver}"></script>
<script src="/themes/cart/efcart/assets/js/viewcart.js?v={$Ver}"></script>
<style>
...
<img width="20" src="/themes/clientarea/efcart/assets/images/gold.svg" alt="">
</span>
...
<img width="20" src="/themes/clientarea/efcart/assets/images/CreditCard.png" alt="">
</span>
...
<div class="payDiv">
<div class="custom-control custom-checkboxalign-items-end mr-2">
